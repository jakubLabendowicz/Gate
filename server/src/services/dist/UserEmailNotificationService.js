...
exports.deleteUserEmailNotification = exports.updateUserEmailNotification = exports.findUserEmailNotifications = exports.findUserEmailNotification = exports.createUserEmailNotification = void 0;
...
exports.createUserEmailNotification = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, prisma.userEmailNotification.create({
...
exports.findUserEmailNotification = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var userEmailNotificationFoundCheck, record, responseBodyResult, responseBody, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                return [4 /*yield*/, prisma.userEmailNotification.findUnique({
                        where: {
                            id: req.params.id
                        }
                    })];
            case 1:
                userEmailNotificationFoundCheck = _a.sent();
                if (!userEmailNotificationFoundCheck) {
                    throw new HTTPError_1.NotFoundError("User email notification not found");
                }
                return [4 /*yield*/, prisma.userEmailNotification.findUnique({
...
exports.findUserEmailNotifications = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var userEmailNotificationFoundCheck, records, responseBodyResult, responseBody, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                return [4 /*yield*/, prisma.userEmailNotification.findMany()];
            case 1:
                userEmailNotificationFoundCheck = _a.sent();
...
exports.updateUserEmailNotification = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var userEmailNotificationFoundCheck, userEmailNotification, record, responseBodyResult, responseBody, error_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 4, , 5]);
            ...
            case 2:
                userEmailNotification = _a.sent();
                if (!userEmailNotification) {
                    throw new HTTPError_1.ForbiddenError();
                }
                return [4 /*yield*/, prisma.userEmailNotification.update({
                        where: {
                            id: req.params.id
                        },
                        data: __assign({}, req.body.data)
...
exports.deleteUserEmailNotification = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var userEmailNotificationFoundCheck, userEmailNotification, record, responseBodyResult, responseBody, error_5;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 4, , 5]);
            ...
            case 2:
                ...
                return [4 /*yield*/, prisma.userEmailNotification["delete"]({
                        where: {
                            id: req.params.id
                        }
                    })];
