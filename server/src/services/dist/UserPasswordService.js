...
exports.deleteUserPassword = exports.updateUserPassword = exports.findUserPasswords = exports.findUserPassword = exports.createUserPassword = void 0;
...
exports.createUserPassword = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var userPasswordCode, salt, hashPassword, record, responseBodyResult, responseBody, error_1;
...
exports.findUserPassword = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var userPasswordFoundCheck, record, responseBodyResult, responseBody, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                return [4 /*yield*/, prisma.userPassword.findUnique({
                        where: {
                            id: req.params.id
                        }
                    })];
            case 1:
                userPasswordFoundCheck = _a.sent();
                if (!userPasswordFoundCheck) {
                    throw new HTTPError_1.NotFoundError("User password not found");
                }
                return [4 /*yield*/, prisma.userPassword.findUnique({
...
exports.findUserPasswords = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var userPasswordFoundCheck, records, responseBodyResult, responseBody, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                return [4 /*yield*/, prisma.userPassword.findMany()];
            case 1:
                userPasswordFoundCheck = _a.sent();
...
exports.updateUserPassword = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var userPasswordFoundCheck, userPassword, record, responseBodyResult, responseBody, error_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 4, , 5]);
            ...
            case 2:
                ...
                return [4 /*yield*/, prisma.userPassword.update({
                        where: {
                            id: req.params.id
                        },
...
exports.deleteUserPassword = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var userPasswordFoundCheck, userPassword, record, responseBodyResult, responseBody, error_5;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 4, , 5]);
            ...
            case 2:
                ...
                return [4 /*yield*/, prisma.userPassword["delete"]({
                        where: {
                            id: req.params.id
                        }
                    })];
