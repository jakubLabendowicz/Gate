...
exports.deleteClient = exports.updateClient = exports.findClients = exports.findClient = exports.createClient = void 0;
...
exports.createClient = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var client, clientSecret, record, responseBodyResult, responseBody, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                client = _a.sent();
                if (client) {
                    throw new HTTPError_1.ConflictError("Client already exists");
                }
                ...
                return [4 /*yield*/, prisma.client.create({
                        data: __assign(__assign({}, req.body.data), { secret: clientSecret })
                    })];
            case 2:
                record = _a.sent();
...
exports.findClient = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
...
exports.findClients = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                records = _a.sent();
                if (records.length === 0) {
                    throw new HTTPError_1.NotFoundError("Clients not found");
                }
...
exports.updateClient = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var client, record, responseBodyResult, responseBody, error_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
...
exports.deleteClient = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var client, record, responseBodyResult, responseBody, error_5;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
