...
exports.deleteUserVerificationCode = exports.updateUserVerificationCode = exports.findUserVerificationCodes = exports.findUserVerificationCode = exports.createUserVerificationCode = void 0;
...
var UserVerificationCodeUtils_1 = require("../utils/UserVerificationCodeUtils");
var prisma = new client_1.PrismaClient();
exports.createUserVerificationCode = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        switch (_a.label) {
            ...
            case 1:
                ...
                if (user.emailVerified === true) {
                    throw new HTTPError_1.ConflictError("User already verified");
                }
                ...
                return [4 /*yield*/, UserVerificationCodeUtils_1.processUserVerificationCode(user)];
            case 2:
                record = _a.sent();
...
exports.findUserVerificationCode = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var userVerificationCodeFoundCheck, record, responseBodyResult, responseBody, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
            ...
            case 1:
                userVerificationCodeFoundCheck = _a.sent();
                if (!userVerificationCodeFoundCheck) {
                    throw new HTTPError_1.NotFoundError("User verification code not found");
                }
                return [4 /*yield*/, prisma.userVerificationCode.findUnique({
...
exports.findUserVerificationCodes = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var userVerificationCodeFoundCheck, records, responseBodyResult, responseBody, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                return [4 /*yield*/, prisma.userVerificationCode.findMany()];
            case 1:
                userVerificationCodeFoundCheck = _a.sent();
                if (userVerificationCodeFoundCheck.length === 0) {
                    throw new HTTPError_1.NotFoundError("User verification codes not found");
                }
                return [4 /*yield*/, prisma.userVerificationCode.findMany({
...
exports.updateUserVerificationCode = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var userVerificationCodeFoundCheck, userVerificationCode, record, responseBodyResult, responseBody, error_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 4, , 5]);
            ...
            case 2:
                ...
                return [4 /*yield*/, prisma.userVerificationCode.update({
                        where: {
                            id: req.params.id
                        },
...
exports.deleteUserVerificationCode = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var userVerificationCodeFoundCheck, userVerificationCode, record, responseBodyResult, responseBody, error_5;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 4, , 5]);
            ...
            case 2:
                ...
                return [4 /*yield*/, prisma.userVerificationCode["delete"]({
                        where: {
                            id: req.params.id
                        }
                    })];
