...
exports.deleteUserPasswordCode = exports.updateUserPasswordCode = exports.findUserPasswordCodes = exports.findUserPasswordCode = exports.createUserPasswordCode = void 0;
...
exports.createUserPasswordCode = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, UserPasswordCodeUtils_1.processUserPasswordCode(user)];
            case 2:
                record = _a.sent();
...
exports.findUserPasswordCode = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var userPasswordCodeFoundCheck, record, responseBodyResult, responseBody, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
            ...
            case 1:
                userPasswordCodeFoundCheck = _a.sent();
                if (!userPasswordCodeFoundCheck) {
                    throw new HTTPError_1.NotFoundError("User password code not found");
                }
                return [4 /*yield*/, prisma.userPasswordCode.findUnique({
...
exports.findUserPasswordCodes = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var userPasswordCodeFoundCheck, records, responseBodyResult, responseBody, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                return [4 /*yield*/, prisma.userPasswordCode.findMany()];
            case 1:
                userPasswordCodeFoundCheck = _a.sent();
...
exports.updateUserPasswordCode = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var userPasswordCodeFoundCheck, userPasswordCode, record, responseBodyResult, responseBody, error_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 4, , 5]);
...
exports.deleteUserPasswordCode = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var userPasswordCodeFoundCheck, userPasswordCode, record, responseBodyResult, responseBody, error_5;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 4, , 5]);
            ...
            case 2:
                ...
                return [4 /*yield*/, prisma.userPasswordCode["delete"]({
                        where: {
                            id: req.params.id
                        }
                    })];
