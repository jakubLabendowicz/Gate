...
exports.deletePermission = exports.updatePermission = exports.findPermissions = exports.findPermission = exports.createPermission = void 0;
...
exports.createPermission = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var permission, record, responseBodyResult, responseBody, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                permission = _a.sent();
                if (permission) {
                    throw new HTTPError_1.ConflictError("Permission already exists");
                }
...
exports.findPermission = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                record = _a.sent();
                if (!record) {
                    throw new HTTPError_1.NotFoundError("Permission not found");
                }
...
exports.findPermissions = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
...
exports.updatePermission = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var permission, record, responseBodyResult, responseBody, error_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
            ...
            case 1:
                ...
                return [4 /*yield*/, prisma.permission.update({
                        where: {
                            id: req.params.id
                        },
                        data: __assign({}, req.body.data)
...
exports.deletePermission = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var permission, record, responseBodyResult, responseBody, error_5;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
            ...
            case 1:
                ...
                return [4 /*yield*/, prisma.permission["delete"]({
                        where: {
                            id: req.params.id
                        }
                    })];
