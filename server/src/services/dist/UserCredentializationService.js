...
exports.createUserPassword = exports.deactivateUserPasswordCode = exports.checkUserPasswordCode = exports.createUserPasswordCode = void 0;
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, UserPasswordCodeUtils_1.sendUserPasswordCode(user)];
            case 2:
                record = _a.sent();
                responseBody = {
                    data: {
...
exports.createUserPassword = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 4:
                record = _a.sent();
                new MailUtils_1.MailBuilder()
                    .withRecipient(userPasswordCode.user.email)
