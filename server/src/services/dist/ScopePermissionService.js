...
exports.deleteScopePermission = exports.updateScopePermission = exports.findScopePermissions = exports.findScopePermission = exports.createScopePermission = void 0;
...
exports.createScopePermission = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var scopePermission, record, responseBodyResult, responseBody, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                return [4 /*yield*/, prisma.scopePermission.findFirst({
                        where: {
            ...
            case 1:
                scopePermission = _a.sent();
                if (scopePermission) {
                    throw new HTTPError_1.ConflictError("Scope permission already exists");
                }
                return [4 /*yield*/, prisma.scopePermission.create({
...
exports.findScopePermission = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var record, responseBodyResult, responseBody, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, prisma.scopePermission.findUnique({
                        where: {
                            id: req.params.id
                        }
                    })];
            case 1:
                record = _a.sent();
                if (!record) {
                    throw new HTTPError_1.NotFoundError("Scope permission not found");
                }
...
exports.findScopePermissions = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var records, responseBodyResult, responseBody, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, prisma.scopePermission.findMany()];
            case 1:
                records = _a.sent();
                if (records.length === 0) {
                    throw new HTTPError_1.NotFoundError("Scope permission not found");
...
exports.updateScopePermission = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var scopePermission, record, responseBodyResult, responseBody, error_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
            ...
            case 1:
                ...
                return [4 /*yield*/, prisma.scopePermission.update({
                        where: {
                            id: req.params.id
                        },
                        data: __assign({}, req.body.data)
...
exports.deleteScopePermission = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var scopePermission, record, responseBodyResult, responseBody, error_5;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
            ...
            case 1:
                ...
                return [4 /*yield*/, prisma.scopePermission["delete"]({
                        where: {
                            id: req.params.id
                        }
                    })];
