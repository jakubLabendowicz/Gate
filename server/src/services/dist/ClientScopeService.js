...
exports.deleteClientScope = exports.updateClientScope = exports.findClientScopes = exports.findClientScope = exports.createClientScope = void 0;
...
exports.createClientScope = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var clientScope, record, responseBodyResult, responseBody, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                return [4 /*yield*/, prisma.clientScope.findFirst({
                        where: {
            ...
            case 1:
                clientScope = _a.sent();
                if (clientScope) {
                    throw new HTTPError_1.ConflictError("Client scope already exists");
                }
                return [4 /*yield*/, prisma.clientScope.create({
...
exports.findClientScope = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var record, responseBodyResult, responseBody, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, prisma.clientScope.findUnique({
                        where: {
                            id: req.params.id
                        }
                    })];
            case 1:
                record = _a.sent();
                if (!record) {
                    throw new HTTPError_1.NotFoundError("Client scope not found");
                }
...
exports.findClientScopes = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var records, responseBodyResult, responseBody, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, prisma.clientScope.findMany()];
            case 1:
                records = _a.sent();
                if (records.length === 0) {
                    throw new HTTPError_1.NotFoundError("Client scope not found");
...
exports.updateClientScope = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var clientScope, record, responseBodyResult, responseBody, error_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
            ...
            case 1:
                ...
                return [4 /*yield*/, prisma.clientScope.update({
                        where: {
                            id: req.params.id
                        },
                        data: __assign({}, req.body.data)
...
exports.deleteClientScope = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var clientScope, record, responseBodyResult, responseBody, error_5;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
            ...
            case 1:
                ...
                return [4 /*yield*/, prisma.clientScope["delete"]({
                        where: {
                            id: req.params.id
                        }
                    })];
