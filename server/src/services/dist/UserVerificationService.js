...
exports.checkUserVerificationCode = exports.createUserVerificationCode = void 0;
...
exports.createUserVerificationCode = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                user = _a.sent();
                if (!user) {
                    throw new Response_1.ResponseError("User not found", "Check email", 404);
                }
                if (user.active === false) {
                    throw new Response_1.ResponseError("User already deactivated", "Check email", 404);
                }
                if (user.emailVerified === true) {
                    throw new Response_1.ResponseError("User already verified", "Check email", 404);
                }
                return [4 /*yield*/, UserVerificationCodeUtils_1.sendUserVerificationCode(user)];
            case 2:
                record = _a.sent();
                responseBody = {
                    data: {
...
exports.checkUserVerificationCode = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var userVerificationCode, user, responseBody, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
