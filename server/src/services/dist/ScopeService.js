...
exports.deleteScope = exports.updateScope = exports.findScopes = exports.findScope = exports.createScope = void 0;
...
exports.createScope = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var scope, record, responseBodyResult, responseBody, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                return [4 /*yield*/, prisma.scope.findUnique({
                        where: {
            ...
            case 1:
                scope = _a.sent();
                if (scope) {
                    throw new HTTPError_1.ConflictError("Scope already exists");
                }
                return [4 /*yield*/, prisma.scope.create({
...
exports.findScope = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                record = _a.sent();
                if (!record) {
                    throw new HTTPError_1.NotFoundError("Scope not found");
                }
...
exports.findScopes = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var records, responseBodyResult, responseBody, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, prisma.scope.findMany()];
            case 1:
                records = _a.sent();
                if (records.length === 0) {
                    throw new HTTPError_1.NotFoundError("Scope not found");
...
exports.updateScope = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var scope, record, responseBodyResult, responseBody, error_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
            ...
            case 1:
                ...
                return [4 /*yield*/, prisma.scope.update({
                        where: {
                            id: req.params.id
                        },
                        data: __assign({}, req.body.data)
...
exports.deleteScope = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var scope, record, responseBodyResult, responseBody, error_5;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
            ...
            case 1:
                ...
                return [4 /*yield*/, prisma.scope["delete"]({
                        where: {
                            id: req.params.id
                        }
                    })];
