...
exports.deleteRolePermission = exports.updateRolePermission = exports.findRolePermissions = exports.findRolePermission = exports.createRolePermission = void 0;
...
exports.createRolePermission = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var rolePermission, record, responseBodyResult, responseBody, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                if (rolePermission) {
                    throw new HTTPError_1.ConflictError("Role permission already exists");
                }
...
exports.findRolePermission = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var record, responseBodyResult, responseBody, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, prisma.rolePermission.findUnique({
                        where: {
                            id: req.params.id
                        }
                    })];
            case 1:
                record = _a.sent();
                if (!record) {
                    throw new HTTPError_1.NotFoundError("Role permission not found");
                }
...
exports.findRolePermissions = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var records, responseBodyResult, responseBody, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, prisma.rolePermission.findMany()];
            case 1:
                records = _a.sent();
                if (records.length === 0) {
                    throw new HTTPError_1.NotFoundError("Role permission not found");
...
exports.updateRolePermission = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var rolePermission, record, responseBodyResult, responseBody, error_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
            ...
            case 1:
                ...
                return [4 /*yield*/, prisma.rolePermission.update({
                        where: {
                            id: req.params.id
                        },
                        data: __assign({}, req.body.data)
...
exports.deleteRolePermission = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var rolePermission, record, responseBodyResult, responseBody, error_5;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
            ...
            case 1:
                ...
                return [4 /*yield*/, prisma.rolePermission["delete"]({
                        where: {
                            id: req.params.id
                        }
                    })];
