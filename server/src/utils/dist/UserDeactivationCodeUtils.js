...
exports.processUserDeactivationCode = void 0;
var UserEmailNotificationBuilder_1 = require("../builders/UserEmailNotificationBuilder");
var client_1 = require("@prisma/client");
var prisma = new client_1.PrismaClient();
exports.processUserDeactivationCode = function (user) { return __awaiter(void 0, void 0, Promise, function () {
    var record, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, prisma.userDeactivationCode.create({
                        data: {
                            userId: user.id,
